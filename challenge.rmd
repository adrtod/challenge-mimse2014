...
Le 4 janv. 2015 :
  ~ Note sur la prise en compte des coûts : [![](`r glyphicon("download_alt")`)](https://www.dropbox.com/s/s618w3osybt9wo2/note_challenge.pdf?dl=1)
...
| ---- | ---- | ----------- | ----- |
| Apprentissage | `data_train.rda` | `data.frame` avec ```r nrow(data_train)``` lignes/clients et ```r ncol(data_train)``` colonnes/variables | [![](`r glyphicon("download_alt")`)](https://www.dropbox.com/s/5txejhqamm6bjzp/data_train.RData?dl=1) |
| Test | `data_test.rda` | `data.frame` avec ```r nrow(data_test)``` lignes/clients et ```r ncol(data_test)``` colonnes/variables | [![](`r glyphicon("download_alt")`)](https://www.dropbox.com/s/t6pt2d9kog173yv/data_test.rda?dl=1) |
...
- Note sur la prise en compte des coûts : [![](`r glyphicon("download_alt")`)](ttps://www.dropbox.com/s/s618w3osybt9wo2/note_challenge.pdf?dl=1)
